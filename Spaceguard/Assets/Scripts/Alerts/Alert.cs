...
public class Alert : MonoBehaviour
{
    ...
    public void RemoveAlert()
    {
        ...
        else if (this.GetComponentInChildren<Text>().text == "December 4, 2017")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "April 7, 2018")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "November 29, 2018")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "June 7, 2019")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "January 2, 2020")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "July 23, 2020")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "March 14, 2021")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "October 13, 2022")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "May 9, 2023")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "December 11, 2024")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "February 16, 2025")
        {
        ...
        else if (this.GetComponentInChildren<Text>().text == "August 1, 2026")
        {
